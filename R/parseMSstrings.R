...
#' parse_mods
#' Parse amino acid sequences with embedded protein modifications
#' 
#' @param seqs Character vector of amino acid sequences with modification metadata
#' @param format Character value specifying the format (only Spectronaut format is currently supported)
#' 
#' @return A data.frame with three columns: `sequence`, a list of AAString objects, `mods`, a list of modification metadata, and `mods_at`, a list of locations of the modifications.
#' @export
